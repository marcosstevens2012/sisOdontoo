				...
				<table id="example1" class="table table-bordered table-striped">
					...
					<tr>	
						...
						<td>	
							...
							@if ($user==1)
							@if ($tur->estado =='En consultorio')
							<a href="{{URL::action('PacienteController@show' , $tur->idpaciente)}}?profesional={{$tur->idprofesional}}"><button class="btn-xs btn-primary">Paciente</button></a>
							@endif
							@endif
					...
					@include('turno.turno.modal-finalizado')
					@endforeach
				</table>
