...
@section ('contenido')
	...
	{!! Form::open(array('url'=>'profesional/liquidacion', 'method'=>'POST', 'autocomplete'=>'off'))!!}
	{{Form::token()}}
<div class="row">
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				<label for="mecanico">Profesional</label>
				
				<select name="idmecanico" id="idmecanico" class="form-control selectpicker" data-live-search="true">
				@foreach($personas as $persona)
					<option value="{{$persona->idprofesional}}">{{$persona->nombre . " " . $persona->apellido}}</option>
				@endforeach	
				</select>
			</div>
		</div>
		...
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				<label for="mecanico">Obra Social</label>
				
				<select name="idobrasocial" id="idobrasocial" class="form-control selectpicker" data-live-search="true">
