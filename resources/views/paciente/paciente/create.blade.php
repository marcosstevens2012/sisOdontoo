	...
	<div class="row">
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group ">
				<label>Nombre*</label>
				<input class='form-control'  style="text-transform:uppercase;" onkeyup="aMays(event, this)" onblur="aMays(event, this)" required value="{{old('nombre')}}" type="text" name="nombre" required="required" 
         		title="Solo letras, maximo 30 minimo 5"/>
			</div>
		</div>
		...
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group ">
				...
				<input class='form-control'  style="text-transform:uppercase;" onkeyup="aMays(event, this)" onblur="aMays(event, this)" title="Se necesita un apellido" required value="{{old('apellido')}}" required="required" type="text" id="apellido" name="apellido"/>
			</div>
		</div>
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
		...
		<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
			<div class="form-group">
				...
				<textarea name="contradicciones" style="text-transform:uppercase;" onkeyup="aMays(event, this)" onblur="aMays(event, this)" id="Contradicciones"  class="form-control" required value="{{old('contradicciones')}}" placeholder="Alertas Medicas" required></textarea>
			</div>
		</div>
